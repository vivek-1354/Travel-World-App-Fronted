    ...
    <div className="hotel-details-container">
      <div className="host-details">
        ...
        <div className="span hotel-room-details">
          <strong>{numberOfguest}</strong> guests.{" "}
          <strong>{numberOfBedrooms}</strong> bedrooms. {numberOfBeds} beds.{" "}
      ...
      <div className="key-features host-details">
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center gap">
            <span className="apps material-symbols-outlined">apps</span>
            Dedicated Workspace
          </p>
          <span className="span">
        ...
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center gap">
            <span className="apps material-symbols-outlined">apps</span>Great
            Location
          </p>
          <span className="span">
      ...
      <div className="amenities-container">
        ...
        <div className="d-flex gap-xxl">
          ...
          <div className="d-flex direction-column">
            ...
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Patio
              or Balcony
            </span>
          </div>
        </div>
